class PreviewMedia extends HTMLElement {
    ...
    static ensureModal() {
        ...
        modal.innerHTML = `
            ...
            <img
                class="preview-img-el max-h-[90vh] max-w-[90vw] rounded-lg shadow-2xl object-contain"
                alt=""
            >
            <video
        ...
        const previewImg = modal.querySelector(".preview-img-el");
...
// Backward-compat alias so any templates still using <preview-img> continue to work
if (!customElements.get("preview-img")) {
    customElements.define("preview-img", class extends PreviewMedia {});
}

console.log("Defined <preview-media> (and <preview-img> alias) custom elements");
